...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    private Button SendVericationCodeButton, VerifyButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SendVericationCodeButton = (Button) findViewById(R.id.send_ver_code_button);
...
// Save verification iD and resending token so we can use them later
                        mVerifcationId = verificationId;
                        mResendToken = token;

                        loadingBar.dismiss();
                        Toast.makeText(PhoneLoginActivity.this, "Code has been sent, Please enter the code..", Toast.LENGTH_SHORT).show();
